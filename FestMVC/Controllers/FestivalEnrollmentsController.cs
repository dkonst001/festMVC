...
namespace FestMVC.Controllers
{
    public class FestivalEnrollmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,FestivalId")] FestivalEnrollment festivalEnrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserId,FestivalId")] FestivalEnrollment festivalEnrollment)
        {
            if (ModelState.IsValid)
            {
